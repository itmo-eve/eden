...
var cleanCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		if currentContext {
			...
			swtpmSockPath := filepath.Join(filepath.Dir(eveImageFile), defaults.DefaultSwtpmSockFile)
			if err := eden.CleanContext(eveDist, certsDir, filepath.Dir(eveImageFile), evePidFile, eveUUID, vmName, swtpmSockPath, configSaved, eveRemote); err != nil {
